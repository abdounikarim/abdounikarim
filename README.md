...
- [ProofOfConceptFactory/poc-react](https://github.com/ProofOfConceptFactory/poc-react) - Hello from React!👋 application (5 months ago)
...
- [laravel/sail](https://github.com/laravel/sail) ([v1.58.0](https://github.com/laravel/sail/releases/tag/v1.58.0), 2 weeks ago) - Docker files for running a basic Laravel application.
